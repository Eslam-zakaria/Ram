...
@section('title', "Edit a Blog ( $form->name )")
                            ...
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.blogs.update', ['blog' => $form->id]) }}">
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                                ...
                                                <div class="tab-pane fade {{ $loop->first ? "active show" : '' }}" id="{{ $locale }}" role="tabpanel">
                                                    <div class="pt-4 row">
                                                        ...
                                                        <div class="form-group bmd-form-group col-md-12 @error("$locale.name") has-danger @enderror">
                                                            <label for="name_id"> Name {{ $locale }} @if($locale == 'ar')<span class="text-danger">*</span>@endif</label>

                                                            <input type="text"
                                                                   id="name_id"
                                                                   name="{{ $locale }}[name]"
                                                                   placeholder="Enter name"
                                                                   @if(!empty($form->translate($locale)->name)) value="{{ $form->translate($locale)->name }}" @endif
                                                                   class="form-control" />
                                                        ...
                                                        <div class="form-group col-md-6 @error("$locale.slug") has-danger @enderror">
                                                            <label for="slug_id"> Slug {{ $locale }} @if($locale == 'ar')<span class="text-danger">*</span>@endif</label>
                                                        ...
                                                        <div class="form-group col-md-6 @error("$locale.new_slug") has-danger @enderror">
                                                            <label for="new_slug_id"> New Slug {{ $locale }} </label>

                                                            <input type="text"
                                                                   id="new_slug_id"
                                                                   name="{{ $locale }}[new_slug]"
                                                                   placeholder="Enter New slug"
                                                                   @if(!empty($form->translate($locale)->new_slug)) value="{{ $form->translate($locale)->new_slug }}" @endif
                                                                   class="form-control" />
                                                        ...
                                                        <div class="desciption col-md-12">
                                                            <div class="form-group col-md-12 @error("$locale.content") has-danger @enderror">
                                                                <label for="content_name"> Content {{ $locale }} @if($locale == 'ar')<span class="text-danger">*</span>@endif</label>

                                                                <textarea id="content_name"
                                                                          name="{{ $locale }}[content]"
                                                                          class="form-control"
                                                                          rows="10">@if(!empty($form->translate($locale)->content)) {{ $form->translate($locale)->content }} @endif</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="Enter title"
                                                                   @if(!empty($form->translate($locale)->alt_image)) value="{{ $form->translate($locale)->alt_image }}" @endif
                                                                   class="form-control" />
                                                        </div>
                                    ...
                                    <div class="form-group col-md-12 mt-3 @error('category_id') has-danger @enderror">
                                            ...
                                            <select class="custom-select form-control city-type" id="category_id" name="category_id">
                                                ...
                                                @if(!empty($categories))
                                                    ...
                                                    <option value="{{$cat->id}}" @if(!empty($form->category_id)) {{ $form->category_id == $cat->id ? 'selected' : '' }} @endif>{{ $cat->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group col-md-6 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file" name="image" class="dropify" data-height="200" @if(!empty($form->image)) data-default-file="{{ $form->image }}" @endif/>
                                        @if($errors->has('image'))
